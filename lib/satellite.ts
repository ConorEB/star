...
export const predictSatellitePosition = (tle: TleData, observerCoords: UserLocation) => {
...
export const calculateNextPass = (tle: TleData, observerCoords: UserLocation): Date => {
