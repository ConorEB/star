    ...
    return (
        <div className="h-dvh w-full flex justify-center">
            <div className="md:w-2/3 px-8">
                ...
                <p className="pt-4">{`STAR is a web interface that uses your devices motion sensors to align your phone (and antenna) with a specified satellite. It was designed and developed for both beginners and advanced users - employing a similar to design language to`} <Link href={'https://support.apple.com/en-us/101573'} className="text-blue-300">{`Apple's satellite SOS`}</Link></p>
                ...
                <p className="text-white/80">{`Unfortunately not. You need motion sensors which computers don't share.`}</p>

                <p className="pt-4">I have an issue/bug to report</p>
                <p className="text-white/80">Sorry about that, STAR is still a work in progress. Please let me know using the email below!</p>
