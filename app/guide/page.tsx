    ...
    return (
        <div className="h-dvh w-full flex justify-center">
            <div className="md:w-2/3 px-8">
                ...
                <p className="pt-2 pb-12">Made by <a href="https://conor.link" className="text-blue-300">Conor Ebeling</a>. You can contact me at <a className="text-blue-300" href="mailto:hey@conor.link">hey@conor.link</a></p>
            </div>
        </div>
    )
}
