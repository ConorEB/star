...
export default function ManualLocation({ error, setError, setManualLocation }) {
    ...
    return (
        <div className="flex h-dvh items-center justify-center px-8">
            <div className="md:w-1/2">
                ...
                <Input placeholder="Enter Latitude" onChange={(e) => setLatitude(e.target.value)} />
                <Input placeholder="Enter Longitude" onChange={(e) => setLongitude(e.target.value)} />
